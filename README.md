...
Like G\*Power, all analyses assume balanced designs with equal cell sizes, as extending power calculations to unbalanced designs generally requires additional assumptions about group sizes and variance structures. 
...
[`pwranova()` help page](https://mutopsy.github.io/pwranova/reference/pwranova.html).
